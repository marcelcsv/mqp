...
@Named(value = "tagEstacionamentoController")
@ViewScoped
public class TagEstacionamentoController extends AbstractController<TagEstacionamento> {
    ...
    public TagEstacionamentoController() {
        // Inform the Abstract parent controller of the concrete TagEstacionamento Entity
    ...
    private void setIsNumRefMQPCollectionEmpty() {
        TagEstacionamento selected = this.getSelected();
        if (selected != null) {
            TagEstacionamentoFacade ejbFacade = (TagEstacionamentoFacade) this.getFacade();
     ...
     * are retrieved from TagEstacionamento and returns the navigation outcome.
     *
