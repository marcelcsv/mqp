...
@FacesConverter(value = "movimentacaoConverter")
public class MovimentacaoConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Movimentacao) {
            ...
            return getStringKey(o.getIdMovimentacao());
        } else {
    ...
    private MovimentacaoFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(MovimentacaoFacade.class).get();
