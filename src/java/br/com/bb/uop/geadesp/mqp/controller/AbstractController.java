...
import br.com.bb.uop.geadesp.mqp.facade.AbstractFacade;
import br.com.bb.uop.geadesp.mqp.facade.LazyEntityDataModel;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/mqpBundle").getString(itemClass.getSimpleName() + "Updated");
...
//    }
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/mqpBundle").getString(itemClass.getSimpleName() + "Created");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/mqpBundle").getString(itemClass.getSimpleName() + "Deleted");
    ...
    private void persist(PersistAction persistAction, String successMessage) {
        if (selected != null) {
            ...
            try {
                ...
                JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/mqpBundle").getString("PersistenceErrorOccured"));
            }
        }
    }
