...
public class SituacaoConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Situacao) {
            Situacao o = (Situacao) object;
            return getStringKey(o.getIdSituacao());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Situacao.class.getName()});
            return null;
        }
    }

    private SituacaoFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(SituacaoFacade.class).get();
