...
public abstract class AbstractFacade<T> {
    ...
    public void create(T entity) {
        System.out.println("called create entity = ... " + entity.toString());

        try {
            getEntityManager().persist(entity);
        } catch (ConstraintViolationException err) {
            //Logger.getLogger(Level.SEVERE, "Exception: ");
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, null, err);
            err.getConstraintViolations().forEach(erro -> Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, erro.toString()));
        }
